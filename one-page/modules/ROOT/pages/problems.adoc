...
Current effort in bitcoin mining can be split into centralised pools
or p2p pools.

Centralised pools carry out share validation, accounting and reward
distribution using a centralised entity - usually a company.

P2P pools push these operational responsibilities to the edges of the
network - i.e. the miners.

In this section, we consider the problems faced by both these
approaches.
...
Next we present a the possibility of using a federation of operators
to replace centralised pool operators.
